        ...
        <form action="{{ route('super-admin.empresas.atualizar', $empresa->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <label class="flex flex-col gap-2">
                    ...
                    <select name="plano" required
                        ...
                        <option value="quarterly" @selected(old('plano', $empresa->plano) === 'quarterly')>Plano Trimestral
                        </option>
                        <option value="semiannual" @selected(old('plano', $empresa->plano) === 'semiannual')>Plano Semestral
                        </option>
                ...
                <label class="flex flex-col gap-2">
                    <span class="text-sm font-semibold text-slate-600">Senha de Acesso (API Brasil)</span>
                    <input type="text" name="apibrasil_device_name" placeholder="gLGqzbpnDA9SiDa"
                        value="{{ old('apibrasil_device_name', $empresa->apibrasil_device_name) }}"
                        class="{{ $inputBase }}">
                    <span class="text-xs text-slate-500">Senha de acesso do dispositivo na API Brasil.</span>
                </label>

                <label class="flex flex-col gap-2">
                    <span class="text-sm font-semibold text-slate-600">Device ID (API Brasil)</span>
                    <input type="text" name="apibrasil_device_id" placeholder="4db434ed-222d-4a5f-b4e6-63d73e45aa50"
                ...
                <label class="flex flex-col gap-2">
                    ...
                    <input type="text" name="apibrasil_device_token" placeholder="14edb6cf-1398-41c7-9109-af9b584b40ab"
            ...
            <div class="rounded-2xl border border-sky-200 bg-sky-50/70 p-4 text-sm text-slate-700">
                ...
                <ul class="mt-2 space-y-1">
                    ...
                    <li>• Total de mensagens enviadas:
                        <strong>{{ number_format($empresa->total_requisicoes, 0, ',', '.') }}</strong></li>
