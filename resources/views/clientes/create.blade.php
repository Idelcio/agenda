                ...
                <div class="p-6">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Preencha as informações abaixo para cadastrar um novo
                                cliente no sistema.</p>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('clientes.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                :value="old('name')" required autofocus placeholder="Digite o nome completo do cliente" />
