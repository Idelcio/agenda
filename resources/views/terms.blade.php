    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
            ...
            <div class="space-y-8">
                <!-- Termos de Uso -->
                <section>
                    <h2 class="text-2xl font-semibold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2">1. Termos de
                        Uso</h2>

                    <div class="space-y-4 text-gray-700">
                        <h3 class="text-xl font-semibold text-gray-800 mt-4">1.1 Aceitação dos Termos</h3>
                        <p>Ao acessar e usar este sistema de agendamento, você concorda com estes Termos de Uso e nossa
                            Política de Privacidade. Se você não concordar com qualquer parte destes termos, não deverá
                            utilizar nossos serviços.</p>

                        <h3 class="text-xl font-semibold text-gray-800 mt-4">1.2 Descrição do Serviço</h3>
                        <p>Nosso sistema oferece uma plataforma de agendamento automatizado integrada ao WhatsApp,
                            permitindo que você:</p>
                ...
                <section>
                    <h2 class="text-2xl font-semibold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2">2. Política de
                        Privacidade (LGPD)</h2>

                    <div class="space-y-4 text-gray-700">
                        <h3 class="text-xl font-semibold text-gray-800 mt-4">2.1 Compromisso com a Privacidade</h3>
                        <p>Esta Política de Privacidade foi elaborada em conformidade com a Lei Geral de Proteção de
                            Dados (Lei nº 13.709/2018 - LGPD). Levamos sua privacidade a sério e nos comprometemos a
                            proteger seus dados pessoais.</p>

                        <h3 class="text-xl font-semibold text-gray-800 mt-4">2.2 Dados Coletados</h3>
                        <p>Para o funcionamento do sistema de agendamento via chatbot, coletamos apenas os seguintes
                            dados:</p>
                        <ul class="list-disc list-inside ml-4 space-y-2">
                            <li><strong>Dados de cadastro:</strong> Nome, e-mail e número de WhatsApp</li>
                            <li><strong>Dados de agendamento:</strong> Informações sobre compromissos, datas e horários
                            </li>
                            <li><strong>Dados de clientes:</strong> Nome e número de WhatsApp dos seus clientes (quando
                                você os cadastra)</li>
                        </ul>
                        ...
                        <p>Seus dados NÃO são vendidos, alugados ou compartilhados com terceiros para fins comerciais. O
                            único compartilhamento realizado é:</p>
                        <ul class="list-disc list-inside ml-4 space-y-2">
                            <li>Com a API de WhatsApp (API Brasil ou similar) exclusivamente para envio de mensagens
                                autorizadas</li>
                            <li>Quando exigido por lei ou ordem judicial</li>
                        </ul>

                        <h3 class="text-xl font-semibold text-gray-800 mt-4">2.6 Segurança dos Dados</h3>
                        <p>Implementamos medidas de segurança técnicas e administrativas para proteger seus dados contra
                            acesso não autorizado, perda, alteração ou divulgação, incluindo:</p>
                        <ul class="list-disc list-inside ml-4 space-y-2">
                        ...
                        <p>Mantemos seus dados pessoais apenas pelo tempo necessário para as finalidades descritas nesta
                            política, ou conforme exigido por lei. Quando você solicitar a exclusão de sua conta, seus
                            dados serão removidos de nossos sistemas.</p>

                        <h3 class="text-xl font-semibold text-gray-800 mt-4">2.9 Cookies e Tecnologias Similares</h3>
                        <p>Utilizamos cookies essenciais para manter sua sessão ativa e garantir o funcionamento
                            adequado do sistema. Não utilizamos cookies de rastreamento ou publicidade.</p>
                    </div>
                </section>

                <!-- Informações da Empresa -->
                <section>
                    <h2 class="text-2xl font-semibold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2">3. Informações
                        da Empresa</h2>
                ...
                <!-- Alterações -->
                <section>
                    <h2 class="text-2xl font-semibold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2">4. Alterações
                        nestes Termos</h2>

                    <div class="text-gray-700">
                        <p>Reservamo-nos o direito de modificar estes Termos de Uso e Política de Privacidade a qualquer
                            momento. As alterações entrarão em vigor imediatamente após sua publicação no sistema. O uso
                            continuado do serviço após as alterações constitui sua aceitação dos novos termos.</p>
                    </div>
                </section>

                <!-- Contato -->
                <section>
                    <h2 class="text-2xl font-semibold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2">5. Contato
                    </h2>

                    <div class="text-gray-700">
                        <p>Para exercer seus direitos sob a LGPD, esclarecer dúvidas sobre estes termos ou reportar
                            problemas, entre em contato:</p>
                ...
                <!-- Legislação -->
                <section>
                    <h2 class="text-2xl font-semibold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2">6. Lei
                        Aplicável</h2>

                    <div class="text-gray-700">
                        <p>Estes termos são regidos pelas leis da República Federativa do Brasil, especialmente pela Lei
                            nº 13.709/2018 (LGPD), pelo Marco Civil da Internet (Lei nº 12.965/2014) e pelo Código de
                            Defesa do Consumidor (Lei nº 8.078/1990).</p>
                    </div>
                </section>
            </div>
